...
public class RoomService implements IRoomService {
    ...
    public Response addNewRoom(MultipartFile photo, String roomType, BigDecimal roomPrice, String description) {
        ...
        try {
            ...
            // Stocker la photo sous forme de byte[] dans la base de données
            if (photo != null && !photo.isEmpty()) {
                room.setRoomPhoto(photo.getBytes()); // Stockage direct de la photo en tant que byte[]
            }
    ...
    public Response updateRoom(Long roomId, String description, String roomType, BigDecimal roomPrice, MultipartFile photo) {
        ...
        try {
            ...
            // Mise à jour de la photo si une nouvelle photo est fournie
            if (photo != null && !photo.isEmpty()) {
                room.setRoomPhoto(photo.getBytes());  // Mise à jour de la photo en tant que byte[]
            }
